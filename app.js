...
function makePad(p, i) {
    ...
    el.addEventListener("pointerup", function (e) { return __awaiter(_this, void 0, void 0, function () { var target_1, s, a, b, _a, q; var _b; return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (!dragging) return [3 /*break*/, 3];
                target_1 = (_b = document.elementFromPoint(e.clientX, e.clientY)) === null || _b === void 0 ? void 0 : _b.closest(".pad");
                ...
                _a = __read(s.pads.splice(a, 1), 1), q = _a[0];
                s.pads.splice(b, 0, q);
                return [4 /*yield*/, save()];
            case 1:
                _c.sent();
    ...
    el.addEventListener("drop", function (e) { return __awaiter(_this, void 0, void 0, function () { var s, a, b, _a, q; return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                e.preventDefault();
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _a = __values(__spreadArray([], __read(files), false)), _b = _a.next();
                    _e.label = 2;
                case 2:
                    if (!!_b.done) return [3 /*break*/, 5];
                    f = _b.value;
                    if (!audioLike(f)) return [3 /*break*/, 4];
                    _d = { id: uid(), name: f.name, type: f.type || "application/octet-stream" };
                    return [4 /*yield*/, blobFromFile(f)];
                case 3:
                    x = (_d.blob = _e.sent(), _d);
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    if (!!_b.done) return [3 /*break*/, 5];
                    f = _b.value;
                    if (!videoLike(f)) return [3 /*break*/, 4];
                    _d = { id: uid(), name: f.name, type: f.type || "application/octet-stream" };
                    return [4 /*yield*/, blobFromFile(f)];
                case 3:
                    x = (_d.blob = _e.sent(), _d);
...
$('pVideo').onchange = function (e) { if (__spreadArray([], __read(e.target.files), false).some(function (f) { return !videoLike(f); }))
    toast("One or more video files are not recognised by the browser."); };
function savePad() {
    return __awaiter(this, void 0, void 0, function () {
        var s, old, base, af, vf, af_1, af_1_1, f, b, _a, _b, e_3_1, _c, _d, _e;
        var e_3, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    af = __spreadArray([], __read($('pAudio').files), false).filter(audioLike), vf = $('pVideo').files[0];
                    if (!(af.length && !old)) return [3 /*break*/, 10];
                    _h.label = 1;
                case 1:
                    _h.trys.push([1, 7, 8, 9]);
                    af_1 = __values(af), af_1_1 = af_1.next();
                    _h.label = 2;
                case 2:
                    if (!!af_1_1.done) return [3 /*break*/, 6];
                    f = af_1_1.value;
                    return [4 /*yield*/, blobFromFile(f)];
                case 3:
                    b = _h.sent();
                    _b = (_a = s.pads).push;
                    _g = { id: uid(), name: f.name.replace(/\.[^.]+$/, ""), color: base.color, mode: base.mode, lyrics: base.lyrics, trimDb: base.trimDb, audioBlob: b, audioName: f.name, audioType: f.type };
                    return [4 /*yield*/, analyse(b)];
                case 4:
                    _b.apply(_a, [(_g.gainDb = _h.sent(), _g)]);
                    _h.label = 5;
                case 5:
                    af_1_1 = af_1.next();
                    return [3 /*break*/, 2];
                ...
                case 8:
                    try {
                        if (af_1_1 && !af_1_1.done && (_f = af_1.return)) _f.call(af_1);
                    }
                    finally { if (e_3) throw e_3.error; }
                    return [7 /*endfinally*/];
                case 9: return [3 /*break*/, 16];
                case 10:
                    if (!af[0]) return [3 /*break*/, 13];
                    _c = base;
                    return [4 /*yield*/, blobFromFile(af[0])];
                case 11:
                    _c.audioBlob = _h.sent();
...
$('deletePad').onclick = function () { return __awaiter(void 0, void 0, void 0, function () { var s; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            if (!editing)
                return [2 /*return*/];
                ...
                case 8:
                    ...
                    a_1.onended = function () {
                        ...
                        if (settings.finishMode === "next" && s.pads[i + 1]) {
                            var n_1 = s.pads[i + 1];
                            var ne = __spreadArray([], __read(document.querySelectorAll('.pad')), false).find(function (x) { return x.dataset.id === n_1.id; });
                            playPad(n_1, ne);
                        }
                        else {
                            currentAudio = null;
...
$('playBtn').onclick = function () { var p = selectedPad(); if (!p) {
    ...
    return;
} selectPad(p); var idx = currentSet().pads.findIndex(function (x) { return x.id === p.id; }); var el = __spreadArray([], __read(document.querySelectorAll('.pad')), false).find(function (x) { return x.dataset.id === p.id; }) || null; playPad(p, el); };
...
$('nextBtn').onclick = function () { var s = currentSet(), p = selectedPad(), i = s.pads.findIndex(function (x) { return x.id === (p === null || p === void 0 ? void 0 : p.id); }); if (s.pads[i + 1]) {
    ...
    selectPad(n);
    var el = visibleIndex >= 0 ? __spreadArray([], __read(document.querySelectorAll('.pad')), false)[visibleIndex] : null;
...
$('tvPhotoFile').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { var f, p, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            f = e.target.files[0];
            e.target.value = '';
...
$('tvVideoFile').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { var f, p, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            f = e.target.files[0];
            e.target.value = '';
...
$('createSet').onclick = function () { return __awaiter(void 0, void 0, void 0, function () { var name, count, s; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
function importLyricsFile(file) {
    return __awaiter(this, void 0, void 0, function () {
        var p, text, name, pdfjs, pdf, _a, _b, pages, i, page, content, e_4;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    text = '';
                    name = file.name || '';
                    if (!(file.type === 'application/pdf' || ext(name) === 'pdf')) return [3 /*break*/, 11];
...
$('saveLyricsManual').onclick = function () { return __awaiter(void 0, void 0, void 0, function () { var p; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            p = selectedPad();
            if (!p)
...
$('lyricsFile').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
$('lyricsPlayBtn').onclick = function () { var p = selectedPad(); if (p) {
    var el = __spreadArray([], __read(document.querySelectorAll('.pad')), false).find(function (x) { return x.dataset.id === p.id; }) || null;
    playPad(p, el);
    if (lyricAutoScroll)
        startLyricAutoScroll();
} };
$('lyricsStopBtn').onclick = function () { stopAll(); stopLyricAutoScroll(); };
$('padLayout').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { var s; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
$('finishMode').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
$('displayTheme').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
$('padSize').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
$('matchAll').onclick = function () { return __awaiter(void 0, void 0, void 0, function () {
    var s, n, _a, _b, p, _c, e_5_1;
    var e_5, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
...
$('persistBtn').onclick = function () { return __awaiter(void 0, void 0, void 0, function () { var ok; var _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
...
$('clearData').onclick = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
...
$('trackFiles').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
...
$('videoFiles').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
...
function exportPlaylist() {
    return __awaiter(this, void 0, void 0, function () {
        var payload, _a, _b, s, ns, _c, _d, p, q, f, _e, f, _f, f, _g, e_6_1, e_7_1, blob, a;
        var e_7, _h, e_6, _j;
        var _k;
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 1:
                    ...
                    _a = __values(state.sets), _b = _a.next();
                    _l.label = 2;
                case 2:
                    ...
                    _l.label = 3;
                case 3:
                    _l.trys.push([3, 13, 14, 15]);
                    _c = (e_6 = void 0, __values(s.pads)), _d = _c.next();
                    _l.label = 4;
                case 4:
                    if (!!_d.done) return [3 /*break*/, 12];
                    p = _d.value;
                    q = __assign({}, p);
                    if (!p.audioBlob) return [3 /*break*/, 6];
                    f = new File([p.audioBlob], p.audioName || 'audio');
                    _e = q;
                    return [4 /*yield*/, fileToData(f)];
                case 5:
                    _e.audioData = _l.sent();
                    delete q.audioBlob;
                    _l.label = 6;
                case 6:
                    if (!p.videoBlob) return [3 /*break*/, 8];
                    f = new File([p.videoBlob], p.videoName || 'video');
                    _f = q;
                    return [4 /*yield*/, fileToData(f)];
                case 7:
                    _f.videoData = _l.sent();
                    delete q.videoBlob;
                    _l.label = 8;
                case 8:
                    if (!p.tvPhotoBlob) return [3 /*break*/, 10];
                    f = new File([p.tvPhotoBlob], p.tvPhotoName || 'photo');
                    _g = q;
                    return [4 /*yield*/, fileToData(f)];
                case 9:
                    _g.tvPhotoData = _l.sent();
                ...
                case 20:
                    ...
                    a.download = (((_k = currentSet()) === null || _k === void 0 ? void 0 : _k.name) || 'ShowCue-Playlist') + '.showcue.json';
                    a.click();
...
function importPlaylist(file) {
    return __awaiter(this, void 0, void 0, function () {
        var txt, p, _a, _b, s, _c, _d, q, _e, _f, _g, e_8_1, e_9_1;
        var e_9, _h, e_8, _j;
        var _k;
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 1:
                    txt = _l.sent(), p = JSON.parse(txt);
                    if (!(p === null || p === void 0 ? void 0 : p.sets))
                        throw Error('Invalid ShowCue playlist');
                    _l.label = 2;
                case 2:
                    _l.trys.push([2, 18, 19, 20]);
                    _a = __values(p.sets), _b = _a.next();
                    _l.label = 3;
                case 3:
                    if (!!_b.done) return [3 /*break*/, 17];
                    s = _b.value;
                    _l.label = 4;
                case 4:
                    _l.trys.push([4, 14, 15, 16]);
                    _c = (e_8 = void 0, __values(s.pads || [])), _d = _c.next();
                    _l.label = 5;
                case 5:
                    if (!!_d.done) return [3 /*break*/, 13];
                    q = _d.value;
                    if (!q.audioData) return [3 /*break*/, 7];
                    _e = q;
                    return [4 /*yield*/, dataToBlob(q.audioData)];
                case 6:
                    _e.audioBlob = _l.sent();
                    _l.label = 7;
                case 7:
                    if (!q.videoData) return [3 /*break*/, 9];
                    _f = q;
                    return [4 /*yield*/, dataToBlob(q.videoData)];
                case 8:
                    _f.videoBlob = _l.sent();
                    _l.label = 9;
                case 9:
                    if (!q.tvPhotoData) return [3 /*break*/, 11];
                    _g = q;
                    return [4 /*yield*/, dataToBlob(q.tvPhotoData)];
                case 10:
                    _g.tvPhotoBlob = _l.sent();
                    _l.label = 11;
                case 11:
                    delete q.audioData;
                    delete q.videoData;
                ...
                case 20:
                    ...
                    state.current = (_k = state.sets[0]) === null || _k === void 0 ? void 0 : _k.id;
                    return [4 /*yield*/, save()];
                case 21:
                    _l.sent();
                    applySettings();
...
$('playlistFile').onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () { var err_2; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
